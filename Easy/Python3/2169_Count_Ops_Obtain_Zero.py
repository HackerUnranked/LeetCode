...
class Solution:
    def countOperations(self, num1: int, num2: int) -> int:
        count = 0
        # loop while either of the num is zero
        while num1 != 0 and num2 != 0:
            # subtract from num1 if it is bigger
            if num1 >= num2:
                num1 -= num2
            # subtract from num2 
            else:
            ...
            count += 1 # increment count for every iteration because
            # every iteration indicates a move
