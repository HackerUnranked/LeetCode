...
class Solution:
    def minMovesToSeat(self, seats: List[int], students: List[int]) -> int:
        # NOTE: Based off the clues the min difference is taking the arrays in sorted
        #       order and substracting the values from each other then sum the differences
        #       See example below:
        ...
        # sort the array and subtract the differences at each index then sum to get the answer
