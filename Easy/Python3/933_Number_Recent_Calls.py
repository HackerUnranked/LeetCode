...
class RecentCounter:
    ...
    def ping(self, t: int) -> int:
        ...
        # remove all of the times that are too old as
        # we don't need them anymore, t - 3000 gives us a
        # newer min everytime therefore the iterval shifts and
        # some time will no longer be "used".
