...
#    than pivot is maintained. More formally, consider every pi, pj where pi is 
#    the new position of the ith element and pj is the new position of the jth 
#    element. For elements less than pivot, if i < j and nums[i] < pivot and
#    nums[j] < pivot, then pi < pj. Similarly for elements greater than pivot, 
